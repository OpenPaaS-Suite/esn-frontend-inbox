...
describe('The inboxComposerCloseWindowService service', function() {
  let $window, $rootScope, inboxComposerCloseWindowService, inboxComposerStatusMock, INBOX_COMPOSER_STATUS, INBOX_EVENTS;
  ...
  beforeEach(function() {
    ...
    angular.mock.inject(function(_inboxComposerCloseWindowService_, _$window_, _$rootScope_, _INBOX_COMPOSER_STATUS_, _INBOX_EVENTS_) {
  ...
  describe('The setup method', function() {
    ...
    describe('The onbeforeunload handler', function() {
      ...
      it('should return when composer status is OPENING', function() {
        ...
        expect(inboxComposerStatusMock.updateStatus).to.have.been.calledWith(INBOX_COMPOSER_STATUS.DISCARDING);
      });
    });
  });
});
